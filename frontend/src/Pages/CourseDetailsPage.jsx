...
export default function CourseDetailsPage() {
  ...
  const hasDiscount = course.discount && course.discount > 0 && course.discount !== course.price;
        ...
        {course.title && ( 
          <div className="bg-white rounded-xl shadow-2xl p-6 md:p-10">
            ...
            <div className="border-b pb-4 mb-6">
              ...
              <p className="text-lg text-indigo-600 font-medium">{course.category || 'Uncategorized'}</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">About This Course</h2>
                <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">{course.description || "No description is available for this course."}</p>
                ...
                <div className="mt-8 pt-4 border-t">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-600 pl-4">
                    ...
                    <li>Instructor: **{course.instructor || 'Training Team'}**</li>
